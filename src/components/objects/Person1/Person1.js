...
class Person1 extends Group {
	constructor(parent, world, removeIceCream) {
		...
		// loader.load('https://models.readyplayer.me/675a5b4c3aa59b91a37363f6.glb', (gltf) => {
			console.log(gltf);
			model = gltf.scene;
			this.add(model);
			this.model = model;
		...
		this.removeIceCream = removeIceCream;
	}
	...
	update(timeStamp) {
		...
		if (this.keyPress != null && this.cubeBody != null && this.walk != null && this.jump != null) {		
			...
			// Stop jump animation once Person1 hits the ground
